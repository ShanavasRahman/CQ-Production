...
const CustomerController = {
    ...
    register: async (req, res) => {
        ...
        const { companyName, companyEmail, contactPerson, country, companyPhone, address, companyWebsite, userFirstname, userLastname, username, userEmail, userMobile, password, supportEmail, sipSupport, ipdbid, customerType } = req.body;
    ...
    login: async (req, res) => {
        ...
        try {
            ...
            const customer = await Customer.findOne({ userEmail });
            if (!customer) {
