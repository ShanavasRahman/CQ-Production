...
const MyRatesSchema = new mongoose.Schema({
    rateId: { type: String, required: true, default: uuidv4 },
...
const CCRateSchema = new mongoose.Schema({
    ...
    testStatus: { type: String },
    addToTicker: { type: Boolean },
    specialRate: { type: Boolean },
    status: { type: String, required: true },
});
module.exports = mongoose.model('CCRate', CCRateSchema);
...
module.exports = {
    ...
    CCRate: mongoose.model("CCRate", CCRateSchema),
